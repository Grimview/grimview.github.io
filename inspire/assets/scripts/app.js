...
menuToggle.onclick = function() {
  if (menuToggle.getAttribute("href") === "#main-menu") {
    menuToggle.setAttribute("href", "#main-menu-toggle");
    menuToggle.innerHTML = "<button><i class=\"ion-navicon-round\"></i></button>";
  } else {
    menuToggle.setAttribute("href", "#main-menu");
    menuToggle.innerHTML = "<button><i class=\"ion-close-round\"></i></button>";
  }
}
